...
export const editATask = function* () {
    while (true) {
        ...
        let api = "https://dev-dl.tdcx.com:3092/tasks/"+ editAction.payload.toString()
        try {
            const results = yield call(putData, api, {}, {headers: headers})
...
export const deleteATask = function* () {
    while (true) {
        ...
        let api = "https://dev-dl.tdcx.com:3092/tasks/"+ deleteAction.payload.toString()
        try {
